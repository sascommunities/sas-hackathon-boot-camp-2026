...
6. On the same tab look for the variable `tier_Basic` and activate the checkbox `Assess this variable for bias`, this will enable us to talk more about the Trustworthy AI features of SAS Model Studio and then click over to the *Pipelines* tab to get started.
